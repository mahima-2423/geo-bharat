      ...
      <div style={{background:'white',margin:'12px',borderRadius:'16px',border:'3px solid #7f1d1d',overflow:'hidden'}}>
        ...
        <div style={{padding:'14px 16px',fontSize:'13px',lineHeight:'1.7'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'10px',marginTop:'10px'}}>
            <img src="/hindu-english new.jfif" alt="English" style={{width:'100%',borderRadius:'8px',border:'2px solid #000',minHeight:'150px',background:'#eee',objectFit:'contain'}} />
            <img src="/hindu-tamil news.jpeg" alt="Tamil" style={{width:'100%',borderRadius:'8px',border:'2px solid #000',minHeight:'150px',background:'#eee',objectFit:'contain'}} />
          </div>
